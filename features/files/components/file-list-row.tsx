...
export function FileListRow({ file }: { file: FileRecord }) {
  return (
    <Link
      href={`/files/${file.id}`}
      className="grid grid-cols-[1fr_110px_110px_40px] items-center gap-4 border-b border-border px-4 py-3 text-[13px] transition-colors hover:bg-bg-overlay/60 last:border-b-0"
    >
