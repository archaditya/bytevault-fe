    ...
    <section className="border-b border-border py-20">
      <div className="container grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="order-2 lg:order-1">
          <div className="rounded-lg border border-border bg-bg-surface p-5">
            <div className="mb-4 flex items-center justify-between text-[12px] text-ink-faint">
              ...
              <span className="rounded-full border border-border-strong px-2 py-0.5 text-ink-muted">Example</span>
            </div>
        ...
        <div className="order-1 lg:order-2">
          <h2 className="max-w-md text-2xl font-semibold tracking-tight text-ink sm:text-3xl">
          ...
          <ul className="mt-6 space-y-2.5 text-[14px] text-ink-muted">
            ...
            <li className="flex gap-2.5">
              <Check className="mt-0.5 h-4 w-4 shrink-0 text-accent" /> Optional passcode, and you can revoke the link any time
            </li>
            <li className="flex gap-2.5">
              <Check className="mt-0.5 h-4 w-4 shrink-0 text-accent" /> Everything lands in a Received folder in your files
            </li>
          </ul>
          <div className="mt-7">
            <Button asChild>
